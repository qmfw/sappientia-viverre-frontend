                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="sitemap-text">
                          ...
                          <a href="#"
                            >Get clean (water!) | Best water filters</a
                          >
                        </div>
                        <!-- end sitemap text -->
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="sitemap-text">
                          <small>March 28, 2016</small>
                          <a href="#"
                            >5 Beautiful buildings you need to visit without
                            dying</a
                          >
                        </div>
                        <!-- end sitemap text -->
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="sitemap-text">
                          ...
                          <a href="#"
                            >Let's make an introduction to the glorious world of
                            history</a
                          >
                        </div>
                        <!-- end sitemap text -->
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="sitemap-text">
                          ...
                          <a href="#"
                            >Did you see the most beautiful sea in the world?</a
                          >
                        </div>
                        <!-- end sitemap text -->
                      </div>
...
export default {
  name: "SiteMap",
  components: { SideBarWidget, FooterPosts },
  data() {
    return {};
  },
  methods: {},
